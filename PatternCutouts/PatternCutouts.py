...
import CustomComputeFeature, utils, Combine
utils.misc.force_reload_modules('CustomComputeFeature', 'Inputs', 'Errors', 'utils', 'Combine', 'Shared', 'Triangles', 'Rhombuses', 'Cross', 'RoundedRectangle', 'Froli')
