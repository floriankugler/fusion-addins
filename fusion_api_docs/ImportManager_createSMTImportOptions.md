...
```python
returnValue = importManager_var.createSMTImportOptions(filename)
```
...
| Type | Description |
|----|----|
| [SMTImportOptions](SMTImportOptions.md) | The created SMTImportOptions object or null if the creation failed. |
