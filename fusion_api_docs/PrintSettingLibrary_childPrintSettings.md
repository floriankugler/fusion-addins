# PrintSettingLibrary.childPrintSettings Method
...
```python
returnValue = printSettingLibrary_var.childPrintSettings(url)
```
...
|------|----------------|--------------------------------------------------|
| url  | [URL](URL.md) | The URL of the folder to get PrintSettings from. |
