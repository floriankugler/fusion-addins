# MeshShellFeatures.itemByName Method
...
```python
returnValue = meshShellFeatures_var.itemByName(name)
```
...
| Type | Description |
|----|----|
| [MeshShellFeature](MeshShellFeature.md) | Returns the specified item or null if the specified name was not found. |
