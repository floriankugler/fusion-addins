...
```python
returnValue = hemFeatures_var.itemByName(name)
```
...
| Type | Description |
|----|----|
| [HemFeature](HemFeature.md) | Returns the specified item or null if the specified name was not found. |
