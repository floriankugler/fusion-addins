# TessellateFeatures.item Method
...
```python
returnValue = tessellateFeatures_var.item(index)
```
...
| Type | Description |
|----|----|
| [TessellateFeature](TessellateFeature.md) | Returns the specified item or null if an invalid index was specified. |
