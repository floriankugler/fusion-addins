# AssemblyConstraints.itemByName Method
...
```python
returnValue = assemblyConstraints_var.itemByName(name)
```
...
| Type | Description |
|----|----|
| [AssemblyConstraint](AssemblyConstraint.md) | Returns the specified item or null if an invalid name was specified. |
