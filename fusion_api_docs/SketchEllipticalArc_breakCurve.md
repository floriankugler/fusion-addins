# SketchEllipticalArc.breakCurve Method
...
returnValue = sketchEllipticalArc_var.breakCurve(segmentPoint)

# Uses optional arguments.
returnValue = sketchEllipticalArc_var.breakCurve(segmentPoint, createConstraints)
```
