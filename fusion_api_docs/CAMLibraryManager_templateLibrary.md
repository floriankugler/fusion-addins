# CAMLibraryManager.templateLibrary Property
...
propertyValue = cAMLibraryManager_var.templateLibrary
```

## Property Value

This is a read only property whose value is a [CAMTemplateLibrary](CAMTemplateLibrary.md).
