# Features.meshRemeshFeatures Property
...
propertyValue = features_var.meshRemeshFeatures
```

## Property Value

This is a read only property whose value is a [MeshRemeshFeatures](MeshRemeshFeatures.md).
