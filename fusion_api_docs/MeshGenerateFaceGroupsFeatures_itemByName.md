# MeshGenerateFaceGroupsFeatures.itemByName Method
...
```python
returnValue = meshGenerateFaceGroupsFeatures_var.itemByName(name)
```
...
| Type | Description |
|----|----|
| [MeshGenerateFaceGroupsFeature](MeshGenerateFaceGroupsFeature.md) | Returns the specified item or null if the specified name was not found. |
