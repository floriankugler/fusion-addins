# FaceGroup.createForAssemblyContext Method
...
"faceGroup_var" is a variable referencing a [FaceGroup](FaceGroup.md) object.

```python
returnValue = faceGroup_var.createForAssemblyContext(occurrence)
```
...
| Type | Description |
|----|----|
| [FaceGroup](FaceGroup.md) | Returns the new face group proxy or null if this isn't the NativeObject. |
