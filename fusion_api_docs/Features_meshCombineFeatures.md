# Features.meshCombineFeatures Property
...
propertyValue = features_var.meshCombineFeatures
```

## Property Value

This is a read only property whose value is a [MeshCombineFeatures](MeshCombineFeatures.md).
