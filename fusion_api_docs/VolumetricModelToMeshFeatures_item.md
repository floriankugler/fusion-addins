# VolumetricModelToMeshFeatures.item Method
...
```python
returnValue = volumetricModelToMeshFeatures_var.item(index)
```
...
| Type | Description |
|----|----|
| [VolumetricModelToMeshFeature](VolumetricModelToMeshFeature.md) | Returns the specified item or null if an invalid index was specified. |
