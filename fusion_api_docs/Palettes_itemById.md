...
```python
returnValue = palettes_var.itemById(id)
```
...
| Type | Description |
|----|----|
| [Palette](Palette.md) | Returns the palette of the specified id or null if no palette has the specified id. |
