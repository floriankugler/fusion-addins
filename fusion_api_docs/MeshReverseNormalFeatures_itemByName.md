# MeshReverseNormalFeatures.itemByName Method
...
```python
returnValue = meshReverseNormalFeatures_var.itemByName(name)
```
...
| Type | Description |
|----|----|
| [MeshReverseNormalFeature](MeshReverseNormalFeature.md) | Returns the specified item or null if the specified name was not found. |
