...
```python
returnValue = sweepFeature_var.createForAssemblyContext(occurrence)
```
...
| Type | Description |
|----|----|
| [SweepFeature](SweepFeature.md) | Returns the proxy object or null if this isn't the NativeObject. |
