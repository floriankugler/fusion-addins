# DistanceValueCommandInput.hasMinimumValue Property
...
propertyValue = distanceValueCommandInput_var.hasMinimumValue

# Set the value of the property.
distanceValueCommandInput_var.hasMinimumValue = propertyValue
```
