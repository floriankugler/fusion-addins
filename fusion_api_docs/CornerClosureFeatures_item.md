# CornerClosureFeatures.item Method
...
```python
returnValue = cornerClosureFeatures_var.item(index)
```
...
| Type | Description |
|----|----|
| [CornerClosureFeature](CornerClosureFeature.md) | Returns the specified item or null if an invalid index was specified. |
