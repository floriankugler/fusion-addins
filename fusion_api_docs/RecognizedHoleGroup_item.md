# RecognizedHoleGroup.item Method
...
"recognizedHoleGroup_var" is a variable referencing a [RecognizedHoleGroup](RecognizedHoleGroup.md) object.

```python
returnValue = recognizedHoleGroup_var.item(index)
```
