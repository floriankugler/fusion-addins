...
"configurationAppearanceColumn_var" is a variable referencing a ConfigurationAppearanceColumn object.  

```python
# Get the value of the property.
propertyValue = configurationAppearanceColumn_var.title

# Set the value of the property.
configurationAppearanceColumn_var.title = propertyValue
```
