...
Parent Object: [ExtendFeatureInput](ExtendFeatureInput.md)  
...
propertyValue = extendFeatureInput_var.targetBaseFeature

# Set the value of the property.
extendFeatureInput_var.targetBaseFeature = propertyValue
```
