# Features.tessellateFeatures Property
...
propertyValue = features_var.tessellateFeatures
```

## Property Value

This is a read only property whose value is a [TessellateFeatures](TessellateFeatures.md).
