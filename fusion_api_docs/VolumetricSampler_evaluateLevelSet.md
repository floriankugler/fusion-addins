# VolumetricSampler.evaluateLevelSet Method
...
```python
returnValue = volumetricSampler_var.evaluateLevelSet()
```
...
| Type | Description |
|----|----|
| [VolumetricScalarSample](VolumetricScalarSample.md)\[\] | An array of VolumetricScalarSample objectst that contain the results of sampling the volumetric model. |
