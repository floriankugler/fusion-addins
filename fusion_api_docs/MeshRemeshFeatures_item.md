# MeshRemeshFeatures.item Method
...
```python
returnValue = meshRemeshFeatures_var.item(index)
```
...
| Type | Description |
|----|----|
| [MeshRemeshFeature](MeshRemeshFeature.md) | Returns the specified item or null if an invalid index was specified. |
