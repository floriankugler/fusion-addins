# Features.meshReverseNormalFeatures Property
...
propertyValue = features_var.meshReverseNormalFeatures
```

## Property Value

This is a read only property whose value is a [MeshReverseNormalFeatures](MeshReverseNormalFeatures.md).
