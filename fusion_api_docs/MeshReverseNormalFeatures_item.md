# MeshReverseNormalFeatures.item Method
...
```python
returnValue = meshReverseNormalFeatures_var.item(index)
```
...
| Type | Description |
|----|----|
| [MeshReverseNormalFeature](MeshReverseNormalFeature.md) | Returns the specified item or null if an invalid index was specified. |
