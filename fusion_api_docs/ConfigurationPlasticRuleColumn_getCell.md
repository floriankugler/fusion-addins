...
```python
returnValue = configurationPlasticRuleColumn_var.getCell(rowIndex)
```
...
| Type | Description |
|----|----|
| [ConfigurationPlasticRuleCell](ConfigurationPlasticRuleCell.md) | Returns the specified cell if successful and null if an invalid index was specified. |
