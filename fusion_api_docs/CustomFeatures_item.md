...
```python
returnValue = customFeatures_var.item(index)
```
...
| Type | Description |
|----|----|
| [CustomFeature](CustomFeature.md) | Returns the specified item or null if an invalid index was specified. |
