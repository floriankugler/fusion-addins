# MeshCombineFaceGroupsFeatures.item Method
...
```python
returnValue = meshCombineFaceGroupsFeatures_var.item(index)
```
...
| Type | Description |
|----|----|
| [MeshCombineFaceGroupsFeature](MeshCombineFaceGroupsFeature.md) | Returns the specified item or null if an invalid index was specified. |
