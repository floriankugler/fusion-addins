# CustomFeatureEvent.remove Method
...
```python
returnValue = customFeatureEvent_var.remove(handler)
```
...
|----|----|----|
| handler | [CustomFeatureEventHandler](CustomFeatureEventHandler.md) | The handler object to be removed from the event. |
