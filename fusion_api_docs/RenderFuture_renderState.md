# RenderFuture.renderState Property
...
propertyValue = renderFuture_var.renderState
```

## Property Value

This is a read only property whose value is a [LocalRenderStates](LocalRenderStates.md).
