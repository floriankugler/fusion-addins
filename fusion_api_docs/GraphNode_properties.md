...
"graphNode_var" is a variable referencing a GraphNode object.  

```python
# Get the value of the property.
propertyValue = graphNode_var.properties
```

## Property Value

This is a read only property whose value is a [GraphNodeProperties](GraphNodeProperties.md).
