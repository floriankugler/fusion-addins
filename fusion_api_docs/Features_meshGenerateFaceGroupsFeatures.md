# Features.meshGenerateFaceGroupsFeatures Property
...
propertyValue = features_var.meshGenerateFaceGroupsFeatures
```

## Property Value

This is a read only property whose value is a [MeshGenerateFaceGroupsFeatures](MeshGenerateFaceGroupsFeatures.md).
