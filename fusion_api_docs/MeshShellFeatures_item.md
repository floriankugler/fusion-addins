...
```python
returnValue = meshShellFeatures_var.item(index)
```
...
| Type | Description |
|----|----|
| [MeshShellFeature](MeshShellFeature.md) | Returns the specified item or null if an invalid index was specified. |
