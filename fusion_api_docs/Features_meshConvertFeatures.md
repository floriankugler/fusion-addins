# Features.meshConvertFeatures Property
...
propertyValue = features_var.meshConvertFeatures
```

## Property Value

This is a read only property whose value is a [MeshConvertFeatures](MeshConvertFeatures.md).
