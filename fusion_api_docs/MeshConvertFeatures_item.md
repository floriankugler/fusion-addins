# MeshConvertFeatures.item Method
...
```python
returnValue = meshConvertFeatures_var.item(index)
```
...
| Type | Description |
|----|----|
| [MeshConvertFeature](MeshConvertFeature.md) | Returns the specified item or null if an invalid index was specified. |
