...
Parent Object: [CadObjectParameterValue](CadObjectParameterValue.md)  
...
propertyValue = cadObjectParameterValue_var.value

# Set the value of the property.
cadObjectParameterValue_var.value = propertyValue
```
