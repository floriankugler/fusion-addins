# OptimizedOrientationResults.item Method
...
"optimizedOrientationResults_var" is a variable referencing an [OptimizedOrientationResults](OptimizedOrientationResults.md) object.

```python
returnValue = optimizedOrientationResults_var.item(index)
```
