# UserInterface.allToolbarPanels Property
...
propertyValue = userInterface_var.allToolbarPanels
```

## Property Value

This is a read only property whose value is a [ToolbarPanelList](ToolbarPanelList.md).
