...
```python
returnValue = filletEdgeSets_var.addConstantRadiusEdgeSet(entities, radius, isTangentChain)
```
...
| Type | Description |
|----|----|
| [ConstantRadiusFilletEdgeSet](ConstantRadiusFilletEdgeSet.md) | Returns the newly created FilletEdgeSet. |
