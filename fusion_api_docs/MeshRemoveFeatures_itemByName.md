# MeshRemoveFeatures.itemByName Method
...
```python
returnValue = meshRemoveFeatures_var.itemByName(name)
```
...
| Type | Description |
|----|----|
| [MeshRemoveFeature](MeshRemoveFeature.md) | Returns the specified item or null if the specified name was not found. |
