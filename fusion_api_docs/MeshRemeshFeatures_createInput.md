# MeshRemeshFeatures.createInput Method
...
```python
returnValue = meshRemeshFeatures_var.createInput(mesh)
```
...
| Type | Description |
|----|----|
| [MeshRemeshFeatureInput](MeshRemeshFeatureInput.md) | Returns the newly created MeshRemeshFeatureInput object or null if the creation failed. |
