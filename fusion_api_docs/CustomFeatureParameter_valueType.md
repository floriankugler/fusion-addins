# CustomFeatureParameter.valueType Property
...
propertyValue = customFeatureParameter_var.valueType
```

## Property Value

This is a read only property whose value is a [ParameterValueTypes](ParameterValueTypes.md).
