# Features.meshCombineFaceGroupsFeatures Property
...
propertyValue = features_var.meshCombineFaceGroupsFeatures
```

## Property Value

This is a read only property whose value is a [MeshCombineFaceGroupsFeatures](MeshCombineFaceGroupsFeatures.md).
