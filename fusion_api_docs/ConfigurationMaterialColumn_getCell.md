# ConfigurationMaterialColumn.getCell Method
...
```python
returnValue = configurationMaterialColumn_var.getCell(rowIndex)
```
...
| Type | Description |
|----|----|
| [ConfigurationMaterialCell](ConfigurationMaterialCell.md) | Returns the specified cell if successful and null if an invalid index was specified. |
