...
```python
returnValue = combineFeature_var.createForAssemblyContext(occurrence)
```
...
| Type | Description |
|----|----|
| [CombineFeature](CombineFeature.md) | Returns the proxy object or null if this isn't the NativeObject. |
