# SketchControlPointSpline.extend Method
...
returnValue = sketchControlPointSpline_var.extend(endPoint)

# Uses optional arguments.
returnValue = sketchControlPointSpline_var.extend(endPoint, createConstraints)
```
