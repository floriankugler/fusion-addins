# PatchFeatureInput.getContinuity Method
...
"patchFeatureInput_var" is a variable referencing a [PatchFeatureInput](PatchFeatureInput.md) object.  

```python
(returnValue, edges, continuity, weight, isContinuityDirectionFlipped) = patchFeatureInput_var.getContinuity()
```
