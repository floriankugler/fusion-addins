...
Parent Object: [RenderManager](RenderManager.md)  
...
propertyValue = renderManager_var.rendering
```

## Property Value

This is a read only property whose value is a [Rendering](Rendering.md).
