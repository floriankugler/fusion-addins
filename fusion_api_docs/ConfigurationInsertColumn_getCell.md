...
```python
returnValue = configurationInsertColumn_var.getCell(rowIndex)
```
...
| Type | Description |
|----|----|
| [ConfigurationInsertCell](ConfigurationInsertCell.md) | Returns the specified cell if successful and null if an invalid index was specified. |
