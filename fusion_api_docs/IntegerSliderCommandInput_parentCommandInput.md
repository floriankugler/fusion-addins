# IntegerSliderCommandInput.parentCommandInput Property
...
propertyValue = integerSliderCommandInput_var.parentCommandInput
```

## Property Value

This is a read only property whose value is a [CommandInput](CommandInput.md).
