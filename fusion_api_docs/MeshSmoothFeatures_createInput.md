# MeshSmoothFeatures.createInput Method
...
```python
returnValue = meshSmoothFeatures_var.createInput(mesh)
```
...
| Type | Description |
|----|----|
| [MeshSmoothFeatureInput](MeshSmoothFeatureInput.md) | Returns the newly created MeshSmoothFeatureInput object or null if the creation failed. |
