# CAM.manufacturingModels Property
...
propertyValue = cAM_var.manufacturingModels
```

## Property Value

This is a read only property whose value is a [ManufacturingModels](ManufacturingModels.md).
