# TwoSidesToExtentDefinition.parentFeature Property

Parent Object: [TwoSidesToExtentDefinition](TwoSidesToExtentDefinition.md)  
...
propertyValue = twoSidesToExtentDefinition_var.parentFeature
```

## Property Value

This is a read only property whose value is a [Feature](Feature.md).
