...
Parent Object: [HTMLEvent](HTMLEvent.md)  
...
"hTMLEvent_var" is a variable referencing a [HTMLEvent](HTMLEvent.md) object.

```python
returnValue = hTMLEvent_var.add(handler)
```
...
|----|----|----|
| handler | [HTMLEventHandler](HTMLEventHandler.md) | The handler object to be called when this event is fired. |
