# ManufacturingModels.createInput Method
...
```python
returnValue = manufacturingModels_var.createInput()
```
...
| Type | Description |
|----|----|
| [ManufacturingModelInput](ManufacturingModelInput.md) | Returns new ManufacturingModelInput object. |
