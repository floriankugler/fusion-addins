# CAMLibraryManager.machineLibrary Property
...
propertyValue = cAMLibraryManager_var.machineLibrary
```

## Property Value

This is a read only property whose value is a [MachineLibrary](MachineLibrary.md).
