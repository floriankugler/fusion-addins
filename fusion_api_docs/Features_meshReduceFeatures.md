# Features.meshReduceFeatures Property
...
propertyValue = features_var.meshReduceFeatures
```

## Property Value

This is a read only property whose value is a [MeshReduceFeatures](MeshReduceFeatures.md).
