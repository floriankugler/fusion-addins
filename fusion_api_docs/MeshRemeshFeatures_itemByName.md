# MeshRemeshFeatures.itemByName Method
...
```python
returnValue = meshRemeshFeatures_var.itemByName(name)
```
...
| Type | Description |
|----|----|
| [MeshRemeshFeature](MeshRemeshFeature.md) | Returns the specified item or null if the specified name was not found. |
