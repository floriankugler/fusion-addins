# Features.meshRemoveFeatures Property
...
propertyValue = features_var.meshRemoveFeatures
```

## Property Value

This is a read only property whose value is a [MeshRemoveFeatures](MeshRemoveFeatures.md).
