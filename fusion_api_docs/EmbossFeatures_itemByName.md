# EmbossFeatures.itemByName Method
...
```python
returnValue = embossFeatures_var.itemByName(name)
```
...
| Type | Description |
|----|----|
| [EmbossFeature](EmbossFeature.md) | Returns the specified item or null if the specified name was not found. |
