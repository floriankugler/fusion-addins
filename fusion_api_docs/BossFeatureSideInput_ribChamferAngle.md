# BossFeatureSideInput.ribChamferAngle Property
...
propertyValue = bossFeatureSideInput_var.ribChamferAngle

# Set the value of the property.
bossFeatureSideInput_var.ribChamferAngle = propertyValue
```
