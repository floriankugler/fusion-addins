...
# "MyOnlineStatusChangedHandler" is the name of the class that handles the event.
onOnlineStatusChanged = MyOnlineStatusChangedHandler()
application_var.onlineStatusChanged.add(onOnlineStatusChanged)
...
class MyOnlineStatusChangedHandler(adsk.core.ApplicationEventHandler):
    def __init__(self):
        super().__init__()
    def notify(self, args: adsk.core.ApplicationEventArgs):
        # Code to react to the event.
        app.log('In MyOnlineStatusChangedHandler event handler.')
```
