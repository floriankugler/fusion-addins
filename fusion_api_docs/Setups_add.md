...
```python
returnValue = setups_var.add(input)
```
...
| Type               | Description                           |
|--------------------|---------------------------------------|
| [Setup](Setup.md) | Returns newly created Setup instance. |

## Parameters

| Name | Type | Description |
|----|----|----|
| input | [SetupInput](SetupInput.md) | The input holds all the information needed to create a valid setup. |
