# SketchEllipse.breakCurve Method
...
returnValue = sketchEllipse_var.breakCurve(segmentPoint)

# Uses optional arguments.
returnValue = sketchEllipse_var.breakCurve(segmentPoint, createConstraints)
```
