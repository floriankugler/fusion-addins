# MeshSmoothFeatures.itemByName Method
...
```python
returnValue = meshSmoothFeatures_var.itemByName(name)
```
...
| Type | Description |
|----|----|
| [MeshSmoothFeature](MeshSmoothFeature.md) | Returns the specified item or null if the specified name was not found. |
