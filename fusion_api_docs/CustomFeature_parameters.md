# CustomFeature.parameters Property
...
propertyValue = customFeature_var.parameters
```

## Property Value

This is a read only property whose value is a [CustomFeatureParameters](CustomFeatureParameters.md).
