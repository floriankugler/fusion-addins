# BossFeature.alignmentType Property
...
propertyValue = bossFeature_var.alignmentType
```

## Property Value

This is a read only property whose value is a [BossAlignmentTypes](BossAlignmentTypes.md).
