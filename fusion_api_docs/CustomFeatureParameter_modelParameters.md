# CustomFeatureParameter.modelParameters Property
...
propertyValue = customFeatureParameter_var.modelParameters
```

## Property Value

This is a read only property whose value is a [ModelParameters](ModelParameters.md).
