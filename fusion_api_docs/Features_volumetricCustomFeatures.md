# Features.volumetricCustomFeatures Property
...
propertyValue = features_var.volumetricCustomFeatures
```

## Property Value

This is a read only property whose value is a [VolumetricCustomFeatures](VolumetricCustomFeatures.md).
