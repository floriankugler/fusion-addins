# Features.meshSmoothFeatures Property
...
propertyValue = features_var.meshSmoothFeatures
```

## Property Value

This is a read only property whose value is a [MeshSmoothFeatures](MeshSmoothFeatures.md).
