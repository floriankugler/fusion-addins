# GraphicsPreferences.selectionDisplayStyle Property
...
propertyValue = graphicsPreferences_var.selectionDisplayStyle

# Set the value of the property.
graphicsPreferences_var.selectionDisplayStyle = propertyValue
```

## Property Value

This is a read/write property whose value is a [SelectionDisplayStyles](SelectionDisplayStyles.md).
