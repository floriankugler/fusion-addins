# Application.documentActivated Event
...
# "MyDocumentActivatedHandler" is the name of the class that handles the event.
onDocumentActivated = MyDocumentActivatedHandler()
application_var.documentActivated.add(onDocumentActivated)
