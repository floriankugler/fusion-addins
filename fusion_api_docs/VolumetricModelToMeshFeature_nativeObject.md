# VolumetricModelToMeshFeature.nativeObject Property
...
propertyValue = volumetricModelToMeshFeature_var.nativeObject
```

## Property Value

This is a read only property whose value is a [VolumetricModelToMeshFeature](VolumetricModelToMeshFeature.md).
