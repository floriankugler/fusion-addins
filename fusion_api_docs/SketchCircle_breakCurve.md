# SketchCircle.breakCurve Method
...
returnValue = sketchCircle_var.breakCurve(segmentPoint)

# Uses optional arguments.
returnValue = sketchCircle_var.breakCurve(segmentPoint, createConstraints)
```
