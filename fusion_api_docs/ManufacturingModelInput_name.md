# ManufacturingModelInput.name Property

Parent Object: [ManufacturingModelInput](ManufacturingModelInput.md)  

## Description

Name of the new ManufacturingModel. The name is displayed in the browser tree.

## Syntax

"manufacturingModelInput_var" is a variable referencing a ManufacturingModelInput object.  

```python
# Get the value of the property.
propertyValue = manufacturingModelInput_var.name

# Set the value of the property.
manufacturingModelInput_var.name = propertyValue
```
