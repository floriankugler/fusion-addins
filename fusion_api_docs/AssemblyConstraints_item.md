# AssemblyConstraints.item Method
...
```python
returnValue = assemblyConstraints_var.item(index)
```
...
| Type | Description |
|----|----|
| [AssemblyConstraint](AssemblyConstraint.md) | Returns the specified item or null if an invalid index was specified. |
