# CadMachineAvoidGroupsParameterValue.applyMachineAvoidGroups Method

Parent Object: [CadMachineAvoidGroupsParameterValue](CadMachineAvoidGroupsParameterValue.md)  

## Description

Set the values of the parameter as a collection of MachineAvoidSelectionGroup. This can throw an exception when the combination of group type and machining mode is not allowed by the current toolpath strategy.

## Syntax

"cadMachineAvoidGroupsParameterValue_var" is a variable referencing a [CadMachineAvoidGroupsParameterValue](CadMachineAvoidGroupsParameterValue.md) object.

```python
returnValue = cadMachineAvoidGroupsParameterValue_var.applyMachineAvoidGroups(machineAvoidSelectionGroups)
```
...
|----|----|----|
| machineAvoidSelectionGroups | [MachineAvoidGroups](MachineAvoidGroups.md) |  |
