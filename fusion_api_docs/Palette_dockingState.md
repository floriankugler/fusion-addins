...
propertyValue = palette_var.dockingState

# Set the value of the property.
palette_var.dockingState = propertyValue
```

## Property Value

This is a read/write property whose value is a [PaletteDockingStates](PaletteDockingStates.md).
