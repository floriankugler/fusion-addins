# SketchFittedSpline.extend Method
...
returnValue = sketchFittedSpline_var.extend(endPoint)

# Uses optional arguments.
returnValue = sketchFittedSpline_var.extend(endPoint, createConstraints)
```
