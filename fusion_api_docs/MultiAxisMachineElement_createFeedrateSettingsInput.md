# MultiAxisMachineElement.createFeedrateSettingsInput Method
...
```python
returnValue = multiAxisMachineElement_var.createFeedrateSettingsInput()
```
...
| Type | Description |
|----|----|
| [MultiAxisFeedrateSettingsInput](MultiAxisFeedrateSettingsInput.md) | The MultiAxisFeedrateSettingsInput object |
