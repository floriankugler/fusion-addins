...
```python
returnValue = sketchFixedSpline_var.createForAssemblyContext(occurrence)
```
...
| Type | Description |
|----|----|
| [SketchFixedSpline](SketchFixedSpline.md) | Returns the proxy object or null if this isn't the NativeObject. |
