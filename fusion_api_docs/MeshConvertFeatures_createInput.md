# MeshConvertFeatures.createInput Method
...
```python
returnValue = meshConvertFeatures_var.createInput(inputBodies)
```
...
| Type | Description |
|----|----|
| [MeshConvertFeatureInput](MeshConvertFeatureInput.md) | Returns the newly created MeshConvertFeatureInput object or null if the creation failed. |
