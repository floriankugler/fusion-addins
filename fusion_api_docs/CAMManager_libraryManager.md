...
Parent Object: [CAMManager](CAMManager.md)  
...
propertyValue = cAMManager_var.libraryManager
```

## Property Value

This is a read only property whose value is a [CAMLibraryManager](CAMLibraryManager.md).
