# CustomFeatureDependencies.item Method
...
```python
returnValue = customFeatureDependencies_var.item(index)
```
...
| Type | Description |
|----|----|
| [CustomFeatureDependency](CustomFeatureDependency.md) | Returns the specified item or null if an invalid index was specified. |
