...
"customGraphicsBRepBody_var" is a variable referencing a [CustomGraphicsBRepBody](CustomGraphicsBRepBody.md) object.

```python
returnValue = customGraphicsBRepBody_var.setOpacity(opacity, isOverride)
```
