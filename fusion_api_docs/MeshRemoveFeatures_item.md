# MeshRemoveFeatures.item Method
...
```python
returnValue = meshRemoveFeatures_var.item(index)
```
...
| Type | Description |
|----|----|
| [MeshRemoveFeature](MeshRemoveFeature.md) | Returns the specified item or null if an invalid index was specified. |
