...
Parent Object: [CurvatureCombAnalysis](CurvatureCombAnalysis.md)  
...
propertyValue = curvatureCombAnalysis_var.isLightBulbOn

# Set the value of the property.
curvatureCombAnalysis_var.isLightBulbOn = propertyValue
```
