# Features.meshSeparateFeatures Property
...
propertyValue = features_var.meshSeparateFeatures
```

## Property Value

This is a read only property whose value is a [MeshSeparateFeatures](MeshSeparateFeatures.md).
