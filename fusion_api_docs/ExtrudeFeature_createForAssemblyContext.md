...
```python
returnValue = extrudeFeature_var.createForAssemblyContext(occurrence)
```
...
| Type | Description |
|----|----|
| [ExtrudeFeature](ExtrudeFeature.md) | Returns the proxy object or null if this isn't the NativeObject. |
