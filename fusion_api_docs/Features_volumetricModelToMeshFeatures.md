# Features.volumetricModelToMeshFeatures Property
...
propertyValue = features_var.volumetricModelToMeshFeatures
```

## Property Value

This is a read only property whose value is a [VolumetricModelToMeshFeatures](VolumetricModelToMeshFeatures.md).
