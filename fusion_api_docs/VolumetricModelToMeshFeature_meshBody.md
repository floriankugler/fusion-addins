# VolumetricModelToMeshFeature.meshBody Property
...
propertyValue = volumetricModelToMeshFeature_var.meshBody
```

## Property Value

This is a read only property whose value is a [MeshBody](MeshBody.md).
