# SketchLinearDimension.entityTwo Property
...
propertyValue = sketchLinearDimension_var.entityTwo
```

## Property Value

This is a read only property whose value is a [SketchEntity](SketchEntity.md).
