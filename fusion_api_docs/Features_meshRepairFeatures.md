# Features.meshRepairFeatures Property
...
propertyValue = features_var.meshRepairFeatures
```

## Property Value

This is a read only property whose value is a [MeshRepairFeatures](MeshRepairFeatures.md).
