# HemFeatureInput.setTeardropHem Method
...
```python
returnValue = hemFeatureInput_var.setTeardropHem(edge, radius, length, gap, isFlipped, bendPositionType)
```
...
| length | [ValueInput](ValueInput.md) | The angle of the teardrop hem. |
