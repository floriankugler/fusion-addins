...
Parent Object: [StitchFeatureInput](StitchFeatureInput.md)  
...
propertyValue = stitchFeatureInput_var.targetBaseFeature

# Set the value of the property.
stitchFeatureInput_var.targetBaseFeature = propertyValue
```
