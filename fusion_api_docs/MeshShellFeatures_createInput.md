# MeshShellFeatures.createInput Method
...
```python
returnValue = meshShellFeatures_var.createInput(mesh)
```
...
| Type | Description |
|----|----|
| [MeshShellFeatureInput](MeshShellFeatureInput.md) | Returns the newly created MeshShellFeatureInput object or null if the creation failed. |
