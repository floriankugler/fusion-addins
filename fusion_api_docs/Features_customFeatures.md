# Features.customFeatures Property
...
propertyValue = features_var.customFeatures
```

## Property Value

This is a read only property whose value is a [CustomFeatures](CustomFeatures.md).
