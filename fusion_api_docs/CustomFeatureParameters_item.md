# CustomFeatureParameters.item Method
...
```python
returnValue = customFeatureParameters_var.item(index)
```
...
| Type | Description |
|----|----|
| [CustomFeatureParameter](CustomFeatureParameter.md) | Returns the specified item or null if an invalid index was specified. |
