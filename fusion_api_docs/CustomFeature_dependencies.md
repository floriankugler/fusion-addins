# CustomFeature.dependencies Property
...
propertyValue = customFeature_var.dependencies
```

## Property Value

This is a read only property whose value is a [CustomFeatureDependencies](CustomFeatureDependencies.md).
