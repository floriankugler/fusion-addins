# MeshSeparateFeatures.itemByName Method
...
```python
returnValue = meshSeparateFeatures_var.itemByName(name)
```
...
| Type | Description |
|----|----|
| [MeshSeparateFeature](MeshSeparateFeature.md) | Returns the specified item or null if the specified name was not found. |
