# RecognizedHoleSegment.holeSegmentType Property
...
propertyValue = recognizedHoleSegment_var.holeSegmentType
```

## Property Value

This is a read only property whose value is a [HoleSegmentType](HoleSegmentType.md).
