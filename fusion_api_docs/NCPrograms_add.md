...
```python
returnValue = nCPrograms_var.add(input)
```
...
| Type                       | Description                     |
|----------------------------|---------------------------------|
| [NCProgram](NCProgram.md) | Returns the created NC program. |

## Parameters

| Name | Type | Description |
|----|----|----|
| input | [NCProgramInput](NCProgramInput.md) | NCProgramInput which will be used to create the NC program. |
