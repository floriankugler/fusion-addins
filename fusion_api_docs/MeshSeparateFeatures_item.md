# MeshSeparateFeatures.item Method
...
```python
returnValue = meshSeparateFeatures_var.item(index)
```
...
| Type | Description |
|----|----|
| [MeshSeparateFeature](MeshSeparateFeature.md) | Returns the specified item or null if an invalid index was specified. |
