# MultiAxisMachineElement.createSingularitySettings Method
...
```python
returnValue = multiAxisMachineElement_var.createSingularitySettings()
```
...
| Type | Description |
|----|----|
| [MultiAxisSingularitySettings](MultiAxisSingularitySettings.md) | The MultiAxisSingularitySettings object created. |
