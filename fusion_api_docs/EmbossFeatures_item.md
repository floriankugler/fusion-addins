...
```python
returnValue = embossFeatures_var.item(index)
```
...
| Type | Description |
|----|----|
| [EmbossFeature](EmbossFeature.md) | Returns the specified item or null if an invalid index was specified. |
