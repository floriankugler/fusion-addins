# EmbossFeature.nativeObject Property
...
propertyValue = embossFeature_var.nativeObject
```

## Property Value

This is a read only property whose value is an [EmbossFeature](EmbossFeature.md).
