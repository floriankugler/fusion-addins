# GraphNodeProperties.item Method
...
```python
returnValue = graphNodeProperties_var.item(index)
```
...
| Type | Description |
|----|----|
| [GraphNodeProperty](GraphNodeProperty.md) | Returns the specified item or null if an invalid index was specified. |
