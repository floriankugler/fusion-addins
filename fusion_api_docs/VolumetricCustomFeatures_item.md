# VolumetricCustomFeatures.item Method
...
```python
returnValue = volumetricCustomFeatures_var.item(index)
```
...
| Type | Description |
|----|----|
| [VolumetricCustomFeature](VolumetricCustomFeature.md) | Returns the specified item or null if an invalid index was specified. |
