# SketchDistanceBetweenLineAndPlanarSurfaceDimension.classType Method
...
returnValue = adsk.fusion.SketchDistanceBetweenLineAndPlanarSurfaceDimension.classType()
```
