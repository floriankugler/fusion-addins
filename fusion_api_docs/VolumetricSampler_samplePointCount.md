# VolumetricSampler.samplePointCount Method
...
```python
returnValue = volumetricSampler_var.samplePointCount()
```
...
| Type | Description |
|----|----|
| uinteger | The number of sample points that will be used for sampling the volumetric model. |
