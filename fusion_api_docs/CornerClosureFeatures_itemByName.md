# CornerClosureFeatures.itemByName Method
...
```python
returnValue = cornerClosureFeatures_var.itemByName(name)
```
...
| Type | Description |
|----|----|
| [CornerClosureFeature](CornerClosureFeature.md) | Returns the specified item or null if the specified name was not found. |
