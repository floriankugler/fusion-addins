...
```python
returnValue = toolbarPanels_var.itemById(id)
```
...
| Type | Description |
|----|----|
| [ToolbarPanel](ToolbarPanel.md) | Returns the ToolbarPanel of the specified id or null no panel has the specified id. |
