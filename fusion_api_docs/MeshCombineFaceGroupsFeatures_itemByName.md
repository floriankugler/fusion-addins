# MeshCombineFaceGroupsFeatures.itemByName Method
...
```python
returnValue = meshCombineFaceGroupsFeatures_var.itemByName(name)
```
...
| Type | Description |
|----|----|
| [MeshCombineFaceGroupsFeature](MeshCombineFaceGroupsFeature.md) | Returns the specified item or null if the specified name was not found. |
