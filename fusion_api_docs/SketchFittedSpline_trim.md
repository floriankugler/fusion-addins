# SketchFittedSpline.trim Method
...
returnValue = sketchFittedSpline_var.trim(segmentPoint)

# Uses optional arguments.
returnValue = sketchFittedSpline_var.trim(segmentPoint, createConstraints)
```
