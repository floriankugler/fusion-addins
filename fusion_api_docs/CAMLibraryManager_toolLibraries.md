# CAMLibraryManager.toolLibraries Property
...
propertyValue = cAMLibraryManager_var.toolLibraries
```

## Property Value

This is a read only property whose value is a [ToolLibraries](ToolLibraries.md).
