...
def run(context, runtime_info: RuntimeInfo):
    global _feature
    _feature = DoorLatch(runtime_info)
...
class DoorLatch(custom_compute_feature.CustomComputeFeature):
    ...
    def plugin_desc(self) -> str:
        return 'Creates the geometry for different kinds of door latches'
