...
class LamelloInputs(inputs.Inputs):
    ...
    def __init__(self, units_manager: adsk.core.UnitsManager):
        ...
        self.cabineo_insert_type = inputs.DropDownInput('insertType', 'Insert Type', utils.misc.class_property_values(LamelloInputs.InsertTypes, inputs.DropDownInput.Item), LamelloInputs.InsertTypes.M6x123.value, 'Variant of the Cabineo insert.', lambda: self.size.value == lamello.Type.CABINEO_8_M6.value)
        super().__init__()
